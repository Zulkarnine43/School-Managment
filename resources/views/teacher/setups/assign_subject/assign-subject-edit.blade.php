                    ...
                    <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                      <div class="form-row"> 
                        ...
                        <div class="form-group col-md-2">
                          ...
                          <input type="number" name="full_mark[]" class="form-control" placeholder="Enter Full Mark" value="{{ $assignSubject->full_mark }}">                 
                        </div> 
                        <div class="form-group col-md-2">
                          <label for="pass_mark">Pass Marks</label>
                          <input type="number" name="pass_mark[]" class="form-control" placeholder="Enter Pass Mark" value="{{ $assignSubject->pass_mark }}">                 
                        </div>
                        <div class="form-group col-md-2">
                          <label for="subjective_mark">Subjective Marks</label>
                          <input type="number" name="subjective_mark[]" class="form-control" placeholder="Enter Subjective Mark" value="{{ $assignSubject->subjective_mark }}">                 
                        </div>                    
