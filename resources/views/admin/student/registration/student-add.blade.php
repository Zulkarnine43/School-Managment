        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{ route('students.registration.view') }}" class="btn btn-success float-right btn-sm"><i class="fa fa-list"> View Student</i></a>
            </div>
            <form role="form" action="{{(@$editData)?route('students.registration.update',$editData->student_id):route('students.registration.store')}}" method="POST" enctype="multipart/form-data" id="MyForm">
            @csrf
              ...
              <div class="card-body">
                <div class="form-row">                   
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Enter Student Name" value="{{ @$editData->student->name }}"> 
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="fname" class="form-control" placeholder="Enter Father's Name" value="{{ @$editData->student->fname }}"> 
                    <font style="color: red"> 
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="mname" class="form-control" placeholder="Enter Mother's Name" value="{{ @$editData->student->mname }}"> 
                    <font style="color: red"> 
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="mobile" class="form-control" placeholder="Enter Mobile Number" value="{{ @$editData->student->mobile }}"> 
                    <font style="color: red"> 
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="email" name="email" class="form-control" placeholder="Enter Email Address" value="{{ @$editData->student->email }}"> 
                    <font style="color: red"> 
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="address" class="form-control" placeholder="Enter Address" value="{{ @$editData->student->address }}"> 
                    <font style="color: red"> 
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="date" name="dob" class="form-control" placeholder="Enter Date of Birth" value="{{ @$editData->student->dob }}"> 
                    <font style="color: red"> 
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-primary">@if(isset($editData)) Update Student @else Add Student @endif</button>
              </div>
            </form>            
          </div> 
        </div>        
